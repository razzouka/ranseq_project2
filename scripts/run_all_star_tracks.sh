...
GENOME_FA="${GENOME_FA:-${ROOT_DIR}/../day1_HiC_practice/hic/data/reference/T2T_human.fna}"
CHROM_SIZES="${CHROM_SIZES:-${ROOT_DIR}/../day1_HiC_practice/hic/data/reference/chrom.sizes}"
STAR_INDEX="${STAR_INDEX:-${ROOT_DIR}/../day1_HiC_practice/hic/data/reference/star_index}"
